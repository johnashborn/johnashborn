...
- Built **StudyBot** using Llama.cpp, an offline AI-powered application that uses tinyLlama LLM - [view project](https://github.com/johnashborn/Studybot).
...
- **StudyBot** - [View Project](https://github.com/johnashborn/Studybot)
